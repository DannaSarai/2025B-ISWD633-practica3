...
```
docker run -d --name client-postgres --publish published=9500,target=80 -e PGADMIN_DEFAULT_PASSWORD=54321 -e PGADMIN_DEFAULT_EMAIL=admin@gmail.com --network net-drupal dpage/pgadmin4
```
...
<img width="1919" height="1090" alt="image" src="https://github.com/user-attachments/assets/5f8df86a-8fcc-4f93-89fe-fd079137d483" />

_La instalación puede tomar varios minutos, mientras espera realice un diagrama de los contenedores que ha creado en este apartado._

# COMPLETAR CON EL DIAGRAMA SOLICITADO
<img width="977" height="445" alt="image" src="https://github.com/user-attachments/assets/4343acbf-099a-4fa7-88f8-568cb5564b89" />
